...
# ============================================================================
"""Breadcrumb environment for reward-directed exploration."""

from typing import Any, Dict, Optional

from bsuite.environments import base
from bsuite.experiments.breadcrumb import sweep
...
class Breadcrumb(base.Environment):
  """A sparse tree-like task with a breadcrumb path and a shallow decoy."""
  ...
  def __init__(self,
    ...
    self._decoy_reward = decoy_reward
