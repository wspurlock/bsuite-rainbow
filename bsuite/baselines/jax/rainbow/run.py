...
# ============================================================================
"""Run a Rainbow agent instance (using JAX) on a bsuite experiment."""
...
from bsuite.baselines.jax import rainbow
...
def run(bsuite_id: str) -> str:
  """Runs a Rainbow agent on a given bsuite environment, logging to CSV."""
